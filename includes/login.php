    ...
    $_SESSION['message'] = "
        <div class='container-fluid text-center message'>
            <div class='col-xs-12'>
                ...
                <a href='../public_html/Home' class='btn btn-success' role='button' style='margin: 5px;'>Return to Home</a>
                <a href='../public_html/Registration' class='btn btn-default' role='button' style='margin: 5px;'>Register Now</a>
            </div>
        </div>";
    header("location: ../public_html/message");
    break;
} else {
    $storedSalt = $row['salt'];
    ...
    $_SESSION['message'] = "
        <div class='container-fluid text-center message'>
            <div class='col-xs-12'>
                ...
                <a href='../public_html/Home' class='btn btn-primary' role='button' style='margin: 5px;'>Home</a>
                <a href='../public_html/Leaderboards' class='btn btn-success' role='button' style='margin: 5px;'>Leaderboards</a>
            </div>
        </div>";
} else {
    ...
    $_SESSION['message'] = "
        <div class='container-fluid text-center message'>
            <div class='col-xs-12'>
                ...
                <a href='../public_html/Home' class='btn btn-success' role='button'>Return to Home</a>
            </div>
        </div>";
}
header("location: ../public_html/message");
