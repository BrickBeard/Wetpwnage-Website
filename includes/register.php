...
if($flag == TRUE) {
    ...
    $_SESSION['message'] = "<div class='container-fluid text-center'><div class='col-xs-12'><h1>Thank you for registering with us!</h1><br><p>Feel free to browse the site while we process your information!</p><br><a href='../public_html/Home' class='btn btn-success' role='button'>Return to Home</a></div></div>";
