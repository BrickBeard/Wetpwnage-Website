                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown gamesNav <?php echo $games_active; ?>">
                            ...
                            <ul class="dropdown-content dropdown-menu" role="menu" id="gamesMenu">
                                ...
                                <li><a href="Leaderboards">In-Development</a></li>
                            </ul> 
                        </li>
                        <li class='<?php echo $media_active; ?>'><a href="Games">Games</a></li>
        ...
        <div class="loggedInInfo">
            <?php 
                if (isset ($_SESSION['id'])) {
                    ...
                    echo  "<a href='logout' role='button' class='btn btn-danger btn-xs'>Logout</a>";/*"<a href='myAccount' role='button' class='btn btn-basic btn-xs'>My Account</a>";*/
