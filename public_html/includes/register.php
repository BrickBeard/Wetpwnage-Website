...
if($flag == TRUE) {
    ...
    $sql = "INSERT INTO user_table (id, first_name, last_name, email, username, password, salt, initials) VALUES (DEFAULT, '$first', '$last', '$email', '$username', '$hashed', '$userSalt', '$initials')";
